...
static ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<std::string> PhoneType_strings[2] = {};
...
static const ::PROTOBUF_NAMESPACE_ID::internal::EnumEntry PhoneType_entries[] = {
  { {PhoneType_names + 0, 8}, 1 },
  { {PhoneType_names + 8, 2}, 0 },
  { {PhoneType_names + 10, 3}, 1 },
};
